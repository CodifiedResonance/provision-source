export class Reconciler {
  constructor(refresh,now,{visible=()=>document.visibilityState==='visible',set=setTimeout,clear=clearTimeout}={}){this.refresh=refresh;this.now=now;this.visible=visible;this.set=set;this.clear=clear;this.timer=null;this.running=false;this.pending=false;this.stopped=false;}
